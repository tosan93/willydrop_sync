/**
 * Airtable field mapping for the DEV base.
 * Grouped to match the structure used in the sync layer definitions.
 */
module.exports = {
    cars: {
        // value fields
        ...
        preferred_delivery_date: { id: 'fldif9zcB3D0XNwHL', name: 'preferred_delivery_date' },
        priority: { id: 'fldQvM8mQclJZh7Y4', name: 'urgency_level' },

        // linked fields - airtable link special treatment
        customer_id: { id: 'fldqim04HZTesttdf', name: 'customer_id' }, // Linked to Companies
        pickup_location_id: { id: 'fldXjGb6nUvNWjtnJ', name: 'pickup_location_id' }, // Linked to Locations
        delivery_location_id: { id: 'fldM1VHDwN9NUHVSp', name: 'delivery_location_id' }, // Linked to Locations
        ...
        airtable_id_name_label: { id: 'fld5qsgyr0nDZq73s', name: 'id_cars' } // Formula value (AT -> SB only)
    },
    locations: {
        // value fields
        ...
        airtable_category: { id: 'fldpDzaGjDM6TK37S', name: 'google_place_category' },
        google_places_id: { id: 'fld3zYYev0GQQqT0k', name: 'google_places_id' },
        website: { id: 'fldz547SfDbeC2W2G', name: 'website' },

        // linked fields - airtable link special treatment
        companies: { id: 'fld1knCOHHpR8uQsK', name: 'companies' }, // Linked to Companies

        // special fields
        supabase_id: { id: 'fld95BhzFLnRYNdrw', name: 'supabase_id' },
        airtable_id: { id: null, name: 'airtable_id' }, // Derived from Airtable record id (AT -> SB only)
        airtable_id_name_label: { id: 'fldJ3QXZIWgilPaoT', name: 'id_locations' } // Formula value (AT -> SB only)
    },
    companies: {
        // value fields
        ...
        airtable_id: { id: null, name: 'airtable_id' }, // Derived from Airtable record id (AT -> SB only)
        airtable_id_name_label: { id: 'fldGEgZo8LkRP6iTW', name: 'id_companies' } // Formula value (AT -> SB only)
    },
    loads: {
        // value fields
        ...
        driver_info: { id: 'fldsIXOsmsRPoMgbV', name: 'driver_info' },
        truck_trailer_info: { id: 'fld4YUTI7v63BYqOI', name: 'truck_trailer_info' },
        ...
        airtable_id: { id: null, name: 'airtable_id' }, // Derived from Airtable record id (AT -> SB only)
        airtable_id_name_label: { id: 'fldNWC8NDSvzPwl0l', name: 'id_loads' }, // Formula value (AT -> SB only)
    ...
    users: {
        ...
        // linked fields - airtable link special treatment
        company_id: { id: 'fldMtLqzTum9S9mav', name: 'company_id' }, // Linked to Companies

        // special fields
        supabase_id: { id: 'fldRZxLBxOyBV3loe', name: 'supabase_id' },
        airtable_id: { id: null, name: 'airtable_id' }, // Derived from Airtable record id (AT -> SB only)
        airtable_id_name_label: { id: 'fldgrNIjSzpJzonwt', name: 'id_users' } // Formula value (AT -> SB only)
    },
    bookings: {
        // value fields
        ...
        // linked fields - airtable link special treatment
        load_id: { id: 'fldu0HPDS8X8V5n2D', name: 'load_id' }, // Linked to Loads
        carrier_id: { id: 'fldDxyJqPstbwN8ap', name: 'carrier_id' }, // Linked to Companies
    ...
    requests: {
        ...
        airtable_id: { id: null, name: 'airtable_id' }, // Derived from Airtable record id (AT -> SB only)
        airtable_id_name_label: { id: 'fldlzkwcYqq3CpLxz', name: 'id_requests' } // Formula value (AT -> SB only)
    }
};
